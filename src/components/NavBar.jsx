                ...
                <div className="col-md-8">
                    <ul className="nav justify-content-center">
                        <li className="nav-item">
                            <a className="nav-link text-warning-emphasis" href="#">Remeras</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link text-warning-emphasis" href="#">Abrigos</a>
                        </li>
                        <li className="nav-item">
                            <a className="nav-link text-warning-emphasis" href="#">Pantalones</a>
                        </li>
                    </ul>
                </div>
